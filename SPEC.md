...
## 2. Schema — 11 bảng lõi (DDL rút gọn, đủ để code ngay)
...
CREATE TABLE op (              -- L2: toán tử, append-only
  id UUID PRIMARY KEY,
  kind TEXT CHECK (kind IN ('amend','repeal','suspend','replace','insert','dinh_chinh')),
